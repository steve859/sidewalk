...
class AsymmetricLoss(nn.Module):
    """
    Asymmetric Loss cho Multi-label Classification theo bài báo "Asymmetric Loss For Multi-Label Classification"
    Thường rất hiệu quả khi dữ liệu bị mất cân bằng (imbalanced).
    """
